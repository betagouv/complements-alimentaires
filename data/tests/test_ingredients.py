...
class IngredientTestCase(TestCase):
    ...
    def test_declared_plant_auto_assigned_is_part_request_status(self):
        ...
        Part.objects.create(plant=plant, plantpart=authorised_part, status=IngredientStatus.AUTHORIZED)
        ...
        Part.objects.create(plant=plant, plantpart=unauthorised_part, status=IngredientStatus.NOT_AUTHORIZED)
