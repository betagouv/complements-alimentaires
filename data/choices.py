...
class EuCountryChoices(models.TextChoices):
    """
...
class CountryChoices(models.TextChoices):
    """
    Cette liste reprends les pays UE, et ajoute autres quand nécessaire
    """

    # historique teleicare inclut des entreprises avant le retrait du Royaume-Uni de l'UE
    GREAT_BRITAIN = "GB", "Grande-Bretagne"
    # les pays restants de la liste EuCountryChoices
    FRANCE = "FR", "France"
    GERMANY = "DE", "Allemagne"
    AUSTRIA = "AT", "Autriche"
    BELGIUM = "BE", "Belgique"
