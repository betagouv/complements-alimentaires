...
REDIS_URL= L'instance redis à utiliser pour les tâches asynchrones et le cache des clés API. Par exemple : 'redis://localhost:6379/0'. Pour docker il faut utiliser le nom du conteneur, alors 'redis://redis:6379/0'
