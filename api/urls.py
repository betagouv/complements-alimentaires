...
from api.views import BlogPostsView, BlogPostView, SubscribeNewsletter, LoggedUserView, WebinairesView
...
urlpatterns = {
    ...
    path("webinaires/", WebinairesView.as_view(), name="webinaire_list"),
}
