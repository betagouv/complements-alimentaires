...
class OpenDataDeclarationSerializer(serializers.ModelSerializer):
    ...
    date_retrait = serializers.DateField(required=False, source="effective_withdrawal_date")
    ...
    def get_ingredients_inactifs(self, obj):
        ...
        # c'est que possible d'avoir des micro organismes inactifs dans les déclarations historiques
