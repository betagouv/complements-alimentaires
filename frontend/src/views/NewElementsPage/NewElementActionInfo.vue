<template>
  ...
  >
    <p v-if="element.requestStatus === 'INFORMATION'">
      ...
      <span v-if="element.isPartRequest">d'autorisation de la partie de plante</span>
      <span v-else>d'ajout de l'ingrédient</span>
      <ElementLink :element="element" />
    </p>
    <p v-else-if="element.requestStatus === 'REJECTED'">
      La demande
      <span v-if="element.isPartRequest">d'autorisation de la partie de plante pour</span>
      <span v-else>d'ajout de l'ingrédient</span>
      <ElementLink :element="element" />
      a été refusée
    </p>
    <p v-else-if="element.isPartRequest && element.requestStatus === 'REPLACED'">
