<template>
  <div class="fr-container pb-10">
    <DsfrBreadcrumb :links="[{ to: '/', text: 'Accueil' }, { text: 'Foire aux questions' }]" />
    ...
    <DsfrAccordionsGroup v-model="activeAccordion">
      ...
      <DsfrAccordion title="Comment fonctionne le moteur de recherche ?">
        ...
        <p>
          En consultant les informations sur les doses autorisées, les usages permis et les restrictions réglementaires,
          vous vous assurez que la composition de vos nouveaux produits respecte les normes en vigueur dès la phase de
          conception.
        </p>
        <p>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                Une notification sera envoyée au gestionnaire actuel de l'entreprise via un email, l’informant de votre
                demande d'accès.
              </li>
            </ul>
          </li>
      ...
      <DsfrAccordion title="Comment inviter des collaborateurs à rejoindre mon entreprise ou supprimer leurs accès ?">
        ...
        <ol>
          ...
          <li>
            Renseignez son adresse email. La personne recevra un email pour finaliser l'inscription et son rattachement
            à l'entreprise.
          </li>
        </ol>
        <p>
      ...
      <DsfrAccordion title="Quelles différences entre les rôles de “gestionnaire” et de “déclarant” ?">
        ...
        <p>
          Le déclarant a uniquement le pouvoir de réaliser des déclarations pour le compte de l'entreprise à laquelle il
          est rattaché.
        </p>
        <p>
          <strong>
      ...
      <DsfrAccordion title="Comment déclarer un nouveau produit ?">
        <ol>
          ...
          <li>
            Vous allez alors devoir renseigner les informations sur votre complément alimentaire, qui sont réparties en
            4 onglets distincts :
            <ul>
      ...
      <DsfrAccordion title="Comment enregistrer mon brouillon ?">
        <p>
          ...
          boutons en bas de page "Revenir à l'onglet " ou "Passer à l'onglet ". Si le dossier n’est pas soumis, il sera
          automatiquement sauvegardé en tant que brouillon.
        </p>
      </DsfrAccordion>
      <DsfrAccordion title="Comment remplir les informations demandées dans l’onglet “Produit” ?">
        ...
        <ul>
          ...
          <li>Forme galénique : forme sous laquelle le complément alimentaire se prend (ex : gélules, comprimés...)</li>
          ...
          <li>
            ...
            générale" indique que le produit est destiné à l'ensemble de la population, y compris les nourrissons et les
            enfants. Si vous sélectionnez cette option, il n'est pas nécessaire de cocher les autres cases. 🚀 Nous
            travaillons actuellement à simplifier cette liste et vous tiendrons informés dès que cette mise à jour sera
            effectuée.
          </li>
          <li>
            <strong>Populations à risque</strong>
            : catégories de personnes pour lesquelles la consommation du complément alimentaire peut être déconseillée.
            Les mises en garde et avertissements correspondant à ces populations devront être clairement indiqués sur
            l'étiquetage du produit afin de garantir une utilisation sécurisée.
          </li>
      ...
      >
        ...
        <ol>
          ...
          <li>
            ...
            vitamine, etc.), son nom, sa description, et, dans le cas d’un microorganisme, précisez également son genre
            et son espèce.
          </li>
          <li>
      ...
      <DsfrAccordion title="Quid de la distinction article 15/16 du décret n°2006-352 ?">
        <p>
          Vous n’avez désormais plus besoin de déterminer vous-mêmes si le complément alimentaire relève de l'article 15
          ou 16 du décret n°2006-352. L'algorithme de Compl'Alim se charge automatiquement de cette classification en
          fonction de la composition que vous renseignez. Cela simplifie la procédure et garantit une attribution
      ...
      <DsfrAccordion title="Comment suivre l’état d’avancement de l’instruction de mes dossiers ?">
        ...
        <p>
          Vous pouvez également accéder à une vue récapitulative cliquant sur la carte "Toutes mes déclarations" depuis
          votre tableau de bord. Vous accédez alors un tableau répertoriant l'ensemble de vos déclarations. Ce tableau
          est partagé avec tous les collaborateurs rattachés à votre entreprise sur Compl’Alim, ce qui vous permet de
          suivre collectivement l’avancement de chaque dossier.
        </p>
        <p>
        ...
        <p>
          💡 Le filtre "Types de déclaration affichés" vous permet de sélectionner les dossiers que vous souhaitez voir
          à l’écran, en choisissant les types de déclarations qui vous intéressent : Brouillon, Instruction,
      ...
      <DsfrAccordion title="Comment récupérer l’attestation d’enregistrement de mon dossier ?">
        ...
        <ul>
          <li>
            cliquez sur le nom du produit qui vous intéresse dans le tableau récapitulatif ("Toutes mes déclarations").
          </li>
      ...
      <DsfrAccordion title="Comment gérer une observation/ objection sur votre dossier ?">
        <p>
          ...
          vous rendant sur la page dédiée à ce complément alimentaire. Pour cela, cliquez sur le nom du produit qui vous
          intéresse dans le tableau récapitulatif ("Toutes mes déclarations").
        </p>
        <p>
      ...
      <DsfrAccordion title="Dois-je redéclarer sur Compl’Alim les produits déclarés sur Teleicare ?">
        ...
        <p>
          L’historique de vos déclarations antérieures sera importé sur Compl'Alim d’ici la fin de l’année, ce qui vous
          permettra de retrouver toutes vos informations sans avoir à refaire les démarches. Nous ferons le lien grâce
          au SIRET de l'entreprise (après qu'elle ait été créée sur Compl'Alim).
        </p>
        <p>
