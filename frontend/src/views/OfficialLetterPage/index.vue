<template>
  ...
  <div class="m-12 text-sm text-black">
    <!-- PAGE PRINCIPALE -->
    <!-- Premier en-tête -->
    ...
    <div class="mt-10 flex items-center justify-between">
      ...
      <!-- Date -->
      <div>Paris, le {{ isoToPrettyDate(letterGenerationDate, dateOptions) }}</div>
    </div>

    <!-- Title principal -->
    <div class="mt-10 uppercase text-lg font-bold tracking-tighter">
      <div class="w-2/3 mx-auto text-center">{{ title }}</div>
    </div>
    ...
    <div class="mt-8">
      <p>Madame, Monsieur</p>
      <div class="mt-8">
        Le {{ isoToPrettyDate(declarationDate, dateOptions) }}, vous avez déclaré par voie électronique le produit
        suivant :
      ...
      <p>
        ...
        réglementation applicable aux denrées alimentaires (notamment les règlements (CE) n°178/2002, (UE) n°1169/ 2011
        et n°2283/2015).
      </p>
      <p>
...
<style scoped>
p {
  @apply my-2.5 text-sm leading-5 tracking-tight text-justify;
}

a {
  @apply text-blue-france-sun-113;
}
