  ...
  <div class="mb-4">
    <DsfrAlert
      ...
      description="Les produits que vous avez déjà déclarés sur Téléicare sont en cours d'importation grâce à une correspondance basée sur les SIRET et les numéros de TVA intracommunautaire.
        Certaines informations apparaissent de manière incomplète dans vos historiques (l'étiquettage, l'entreprise mandataire s'il y en a, l'attestation ne sont pas encore disponibles).
