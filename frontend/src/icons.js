...
export const RiVideoChatLine = {
  name: "ri-video-chat-line",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M14 10.25L17 8v6l-3-2.25V14H7V8h7v2.25zM5.763 17H20V5H4v13.385L5.763 17zm.692 2L2 22.5V4a1 1 0 011-1h18a1 1 0 011 1v14a1 1 0 01-1 1H6.455z"/>',
}

export const RiPlantLine = {
  name: "ri-plant-line",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M6 2a7 7 0 016.197 3.741A6.49 6.49 0 0117.5 3H21v2.5a6.5 6.5 0 01-6.5 6.5H13v1h5v7a2 2 0 01-2 2H8a2 2 0 01-2-2v-7h5v-2H9a7 7 0 01-7-7V2h4zm10 13H8v5h8v-5zm3-10h-1.5A4.5 4.5 0 0013 9.5v.5h1.5A4.5 4.5 0 0019 5.5V5zM6 4H4a5 5 0 005 5h2a5 5 0 00-5-5z"/>',
}

export const RiMicroscopeLine = {
  name: "ri-microscope-line",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M13.196 2.268l3.25 5.63a1 1 0 01-.366 1.365l-1.3.75 1.001 1.732-1.732 1-1-1.733-1.299.751a1 1 0 01-1.366-.366L8.546 8.215a5.002 5.002 0 00-3.222 6.561A4.976 4.976 0 018 14c1.684 0 3.174.833 4.08 2.109l7.688-4.439 1 1.732-7.878 4.549A5.038 5.038 0 0112.9 20H21v2l-17 .001A4.979 4.979 0 013 19c0-1.007.298-1.945.81-2.73a7.001 7.001 0 013.717-9.82l-.393-.682a2 2 0 01.732-2.732l2.598-1.5a2 2 0 012.732.732zM8 16a3 3 0 00-2.83 4h5.66A3 3 0 008 16zm3.464-12.732l-2.598 1.5 2.75 4.763 2.598-1.5-2.75-4.763z"/>',
}

export const RiFlaskLine = {
  name: "ri-flask-line",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M16 2v2h-1v3.243c0 1.158.251 2.301.736 3.352l4.282 9.276A1.5 1.5 0 0118.656 22H5.344a1.5 1.5 0 01-1.362-2.129l4.282-9.276A7.994 7.994 0 009 7.243V4H8V2h8zm-2.612 8.001h-2.776c-.104.363-.23.721-.374 1.071l-.158.361L6.125 20h11.749l-3.954-8.567a9.978 9.978 0 01-.532-1.432zM11 7.243c0 .253-.01.506-.029.758h2.058a8.777 8.777 0 01-.021-.364L13 7.243V4h-2v3.243z"/>',
}

export const RiTestTubeLine = {
  name: "ri-test-tube-line",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
...
export const RiArrowLeftLine = {
  ...
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M7.828 11H20v2H7.828l5.364 5.364-1.414 1.414L4 12l7.778-7.778 1.414 1.414z"/>',
}

export const RiInformationLine = {
  name: "ri-information-line",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 100-16 8 8 0 000 16zM11 7h2v2h-2V7zm0 4h2v6h-2v-6z"/>',
}

export const RiAttachment2 = {
  name: "ri-attachment-2",
  minX: 0,
  minY: 0,
  width: 24,
  height: 24,
  raw: '<path fill="none" d="M0 0h24v24H0z"/><path d="M14.828 7.757l-5.656 5.657a1 1 0 101.414 1.414l5.657-5.656A3 3 0 1012 4.929l-5.657 5.657a5 5 0 107.071 7.07L19.071 12l1.414 1.414-5.657 5.657a7 7 0 11-9.9-9.9l5.658-5.656a5 5 0 017.07 7.07L12 16.244A3 3 0 117.757 12l5.657-5.657 1.414 1.414z"/>',
}

export const RiFileTextLine = {
